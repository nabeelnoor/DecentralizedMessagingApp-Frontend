...
func main() {
	...
	router.HandleFunc("/updatebook", hb.UpdateBook).Methods(http.MethodPut)    //update api
	router.HandleFunc("/deletebook", hb.DeleteBook).Methods(http.MethodDelete) //delete api
